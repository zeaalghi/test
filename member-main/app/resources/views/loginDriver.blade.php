    ...
    <div class="container-fluid h-screen">
        <div class="grid md:grid-cols-2 gap-8">
            ...
            <div class="container mx-auto h-screen flex justify-center items-center mt-5">
                <form action="{{ route('aksi.loginDriver') }}" method="POST" class="bg-white w-full max-w-md p-6">
                    @csrf
                    <a href="/">
                    ...
                    <div class="mb-5 text-center">
                        <h5 class="text-3xl font-bold">Login Driver DKWB
                        </h5>
                        <h5 class="font-extralight">Masukkan nomor kartu identitas anda</h5>
                    </div>
                    <div class="mb-6 mt-8">
                        <label for="nik" class="block mb-2 text-sm font-bold text-gray-900 dark:text-white">NIK
