...
@section('content')
                    ...
                    <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                        ...
                        <li aria-current="page">
                            <div class="flex items-center">
                                ...
                                <span
                                    class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Private</span>
                            </div>
                        </li>
                    </ol>
                </nav>
    ...
    <section>
        <div class="container mx-auto">
            <p class="uppercase mx-10 text-4xl mb-4 font-extrabold text-red-700">Private</p>
                            ...
                            <tbody>
                                @foreach ($data as $order)
                                    <tr
                                        ...
                                        <td
                                            class="px-6 py-4 font-medium text-center text-gray-900 whitespace-nowrap dark:text-white">
                                            <a href="{{ route('order.privatePay', ['armada' => $order->id]) }}"
